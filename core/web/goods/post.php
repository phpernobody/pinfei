...
if (!(empty($id)))
{
    ...
    // 添加专柜信息
//    $shoppes = array('id' => 0, 'name' => '非专柜商品');
    $shoppes = array_merge(array(array('id' => 0, 'name' => '非专柜商品')), pdo_fetchall('select * from ' . tablename('ewei_shop_shoppe')));
    // 分类信息
    ...
    if (0 < count($options))
    {
        ...
        $html = '';
        $html .= '<table class="table table-bordered table-condensed"  style="width: 110%; max-width: 110%; margin-left: -5%; background: #fff;">';
        $html .= '<thead>';
        $html .= '<tr class="active">';
        $discounts_html .= '<table class="table table-bordered table-condensed" style="width: 110%; max-width: 110%; margin-left: -5%; background: #fff;">';
        $discounts_html .= '<thead>';
        $discounts_html .= '<tr class="active">';
        $commission_html .= '<table class="table table-bordered table-condensed" style="width: 110%; max-width: 110%; margin-left: -5%; background: #fff;">';
        $commission_html .= '<thead>';
        $commission_html .= '<tr class="active">';
        $isdiscount_discounts_html .= '<table class="table table-bordered table-condensed"  style="width: 110%; max-width: 110%; margin-left: -5%; background: #fff;">';
        ...
        if ($canedit)
        {
            ...
            $html .= '<th><div class=""><div style="padding-bottom:10px;text-align:center;">重量(g)</div><div class="input-group"><input type="text" class="form-control input-sm option_weight_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-angle-double-down" title="批量设置" onclick="setCol(\'option_weight\');"></a></span></div></div></th>';
            $html .= '<th><div class=""><div style="padding-bottom:10px;text-align:center;">省价</div><div class="input-group"><input type="text" class="form-control input-sm option_provinceprice_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-angle-double-down" title="批量设置" onclick="setCol(\'option_provinceprice\');"></a></span></div></div></th>';
            $html .= '<th><div class=""><div style="padding-bottom:10px;text-align:center;">市价</div><div class="input-group"><input type="text" class="form-control input-sm option_cityprice_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-angle-double-down" title="批量设置" onclick="setCol(\'option_cityprice\');"></a></span></div></div></th>';
            $html .= '<th><div class=""><div style="padding-bottom:10px;text-align:center;">区价</div><div class="input-group"><input type="text" class="form-control input-sm option_countyprice_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-angle-double-down" title="批量设置" onclick="setCol(\'option_countyprice\');"></a></span></div></div></th>';
        }
        else
        {
            foreach ($levels as $level )
            ...
            $html .= '<th><div class=""><div style="padding-bottom:10px;text-align:center;">重量(g)</div></th>';
            $html .= '<th><div class=""><div style="padding-bottom:10px;text-align:center;">省价</div></th>';
            $html .= '<th><div class=""><div style="padding-bottom:10px;text-align:center;">市价</div></th>';
            $html .= '<th><div class=""><div style="padding-bottom:10px;text-align:center;">区价</div></th>';
        }
        $html .= '</tr></thead>';
        ...
        while ($i < $newlen)
        {
            ...
            $ids = implode('_', $ids);
            $val = array('id' => '', 'title' => '', 'stock' => '', 'presell' => '', 'costprice' => '', 'productprice' => '', 'marketprice' => '', 'weight' => '', 'provinceprice' => '', 'cityprice' => '', 'countyprice' => '', 'virtual' => '');
            $discounts_val = array('id' => '', 'title' => '', 'level' => '', 'costprice' => '', 'productprice' => '', 'marketprice' => '', 'weight' => '', 'provinceprice' => '', 'cityprice' => '', 'countyprice' => '', 'virtual' => '');
            $isdiscounts_val = array('id' => '', 'title' => '', 'level' => '', 'costprice' => '', 'productprice' => '', 'marketprice' => '', 'weight' => '', 'provinceprice' => '', 'cityprice' => '', 'countyprice' => '', 'virtual' => '');
            $commission_val = array('id' => '', 'title' => '', 'level' => '', 'costprice' => '', 'productprice' => '', 'marketprice' => '', 'weight' => '', 'provinceprice' => '', 'cityprice' => '', 'countyprice' => '', 'virtual' => '');
            foreach ($levels as $level )
            {
            ...
            foreach ($options as $o )
            {
                if ($ids === $o['specs'])
                {
                    $val = array('id' => $o['id'], 'title' => $o['title'], 'stock' => $o['stock'], 'costprice' => $o['costprice'], 'productprice' => $o['productprice'], 'presell' => $o['presellprice'], 'marketprice' => $o['marketprice'], 'goodssn' => $o['goodssn'], 'productsn' => $o['productsn'], 'weight' => $o['weight'], 'provinceprice' => $o['provinceprice'], 'cityprice' => $o['cityprice'], 'countyprice' => $o['countyprice'], 'virtual' => $o['virtual']);
            ...
            if ($canedit)
            {
                ...
                $hh .= '<td><input data-name="option_provinceprice_' . $ids . '" type="text" class="form-control option_provinceprice option_provinceprice_' . $ids . '" " value="' . $val['provinceprice'] . '"/></td>';
                $hh .= '<td><input data-name="option_cityprice_' . $ids . '" type="text" class="form-control option_cityprice option_cityprice_' . $ids . '" " value="' . $val['cityprice'] . '"/></td>';
                $hh .= '<td><input data-name="option_countyprice_' . $ids . '" type="text" class="form-control option_countyprice option_countyprice_' . $ids . '" " value="' . $val['countyprice'] . '"/></td>';
                $hh .= '</tr>';
            }
            else
            {
                ...
                $hh .= '<td>' . $val['weight'] . '</td>';
                $hh .= '<td>' . $val['provinceprice'] . '</td>';
                $hh .= '<td>' . $val['cityprice'] . '</td>';
                $hh .= '<td>' . $val['countyprice'] . '</td>';
                $hh .= '</tr>';
            }
            ++$i;
        }
