            ...
            if (next.html()) {
                ...
                if (list.length > 0) {
                    ...
                    for (var i = list.length - 1; i >= 0; i--) {
                        ...
                        html += list[i]['openid'];
                        html += '" style="height: 4.6rem; align-items: center; margin-top: .5rem; background: #F1F1F1;"><div style="position: relative;">';
                        html += '<img src="';
                        if (list[i]['avatar']) {
                            html += list[i]['avatar'];
                        } else {
                        ...
                        html += '" style="float: left; margin-top: .65rem; width: 3.3rem; height: 3.3rem; margin-left: .5rem">';
                        html += '</div><div style="float: left; margin-top: .65rem; width: calc(100% - 8rem); font-size: .5rem; height: 3.3rem; text-align: left; margin-top: .65rem; margin-left: .5rem;"><div><span style="height: calc(3.3rem / 4); line-height: calc(3.3rem / 4);color: #ff5d15; width: 3.5rem; display: inline-block;">姓名：</span>';
                        ...
                        html += '</div></div><div style="float: right; margin-top: 1.8rem; width: 3rem;"><a href="';
                        html += link + list[i]['id'];
